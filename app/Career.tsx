...
const tabs: Tab[] = [
    {
        ...
        body: (
            <TimeLine>
                ...
                >
                    <p>
                        Collaborated on a project focusing on crafting an AI-driven content generation tool for SMBs, incorporating tools
                        like a Business Name Generator and Brand Creator to elevate brand identity and operational efficiency.
                    </p>
                    <p>
                        Engineered a full-stack application leveraging NextJS and ExpressJS, featuring a responsive UI, intuitive UX, and
                        scalable API endpoints.
                    </p>
                    <p>
                        Ensured robust functionality and consistency through testing with Vitest and react testing library, while seamlessly
                        integrating Docker for project deployment.
                    </p>
                </TimeLineItem>
                <TimeLineItem title='IT Developer' company='Cadre Capital Partners (CCP)' date='Mar 2023 - Nov 2023' empType='Part-Time'>
                    <p>
                        Following a year of notable success in my internship at CPP, I was offered and accepted a permanent position at CCP.
                        Balancing my professional commitments with academic pursuits, I continued to work part-time while completing my
                        studies at RMIT.
                    </p>
                    <p>
                        {
                ...
                >
                    <p>
                        Engineered a customized file system within Microsoft SharePoint using JavaScript, to automatically organize
                        compliance documents, enhancing retrieval and data governance by leveraging document metadata and client
                        information.
                    </p>
                    <p>
                        {
                    ...
                    <p>
                        Developed and sustained automated solutions with PowerShell scripting, significantly improving workflow for
                        advisors.
                    </p>
                </TimeLineItem>
            </TimeLine>
    ...
    },
    {
        ...
        body: (
            <TimeLine>
                ...
                >
                    <p>
                        Studied the International Baccalaureate Diploma Programme, a rigorous and comprehensive curriculum that emphasizes
                        critical thinking
                    </p>
                </TimeLineItem>
            </TimeLine>
    ...
    },
    {
        ...
        body: (
            <TimeLine>
                ...
                >
                    <p>
                        Spearheaded team representation for UAE in the international robotics competition in Shanghai, engineering a LEGO
                        Mindstorms robot with advanced sensor integration for precise line following and task execution
                    </p>
            ...
            <TabsList className='w-full justify-between bg-transparent h-auto flex-wrap'>
                {tabs.map((tab) => {
                    return (
                        ...
                        >
                            {tab.title}
                            <span className={`bg-pink-red h-1 mt-3 ${activeTab == tab ? 'w-full' : 'w-1/4'} duration-700`}></span>
                        </TabsTrigger>
                    );
                })}
            </TabsList>
