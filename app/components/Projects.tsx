                ...
                {props.projects.map((project) => {
                    return (
                        <div className="w-[25rem] h-[20rem]">
                            <div key={project.title} className="group bg-pink-red rounded-2xl overflow-hidden h-[15rem] w-full relative">
                                <img src={project.coverImage} alt={project.title} className="h-full" />
                            ...
                            <div className="flex flex-row flex-wrap h-[4rem] items-center px-2">
                                {project.tags?.map((tag) => {
                                    return (
                                        <span className="bg-transparent text-pink-red-light text-sm font-light px-2 py-1 rounded-lg mr-2 border border-pink-red-light">{tag}</span>
                                    );
                                })}
                            </div>
                        </div>
