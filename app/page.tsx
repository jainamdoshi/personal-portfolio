...
export default function App() {
	const projects: ProjectProps[] = [
		...
		},
		{
			...
			coverImage:
				'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSntz4baDJfyK1oIlc7bTqisO6JcE4OWtdCkQ&usqp=CAU',
		...
		},
		{
			...
			coverImage:
				'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAiJnd952Uj94hWQ98coDhuWzhwUi7Qdsl0ezSLQDQ0XcKh5UWvLgo-X3MYn2_VUQzxE4&usqp=CAU',
		...
		},
		{
			...
			coverImage:
				'https://edsurge.imgix.net/uploads/post/image/14497/bookstore-1637792757.png?auto=compress%2Cformat&w=640&h=259&fit=crop',
		...
		},
		{
			...
			coverImage:
				'https://res.cloudinary.com/practicaldev/image/fetch/s--vCb1OCTR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/RbelQBq.png',
		...
		},
		{
			...
			coverImage:
				'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6qZ3IOASa-CdXKO892g_H-f-DDlpjvgiDrOjVLHfvGFATOsRbBha-oKlpC9M6jEY2mjU&usqp=CAU',
		...
		},
		{
			...
			coverImage: 'https://rachelcorbett.com.au/wp-content/uploads/2020/10/Podcast-stats-explainer.jpg',
